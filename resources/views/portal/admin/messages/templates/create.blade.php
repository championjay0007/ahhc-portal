...
<div class="container-fluid py-4">
    <div class="template-form-container">
        <h1><i class="bi bi-pencil-square"></i> Create New Message Template</h1>
        <p>Design beautiful, personalized message templates for your users</p>
    </div>

    @php
        $selectedTheme = old('theme', 'clean');
        $themeHtmlValue = old('theme_html', $themeHtmlDefaults[$selectedTheme] ?? \App\Services\MessageService::getDefaultThemeHtml($selectedTheme));
    @endphp
    ...
    <div class="row">
        <div class="col-lg-8">
            <form action="{{ route('portal.admin.messages.templates.store') }}" method="POST" id="templateForm">
                @csrf
                ...
                <div class="card-section">
                    ...
                    <div class="form-group-wrapper">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., Welcome Email, Reminder Notice" required>
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="hint-text"><i class="bi bi-lightbulb"></i> Use a descriptive name to identify this template</small>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-wrapper">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                    ...
                                    <option value="care_review" {{ old('type') === 'care_review' ? 'selected' : '' }}>Care Review</option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group-wrapper">
                                <label for="category" class="form-label">
                                    <i class="bi bi-folder"></i> Category (Optional)
                                </label>
                                <input type="text" class="form-control" id="category" name="category" value="{{ old('category') }}" placeholder="e.g., Welcome, Reminders, Updates">
                                <small class="hint-text">Organize templates by category for easier management</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group-wrapper">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group-wrapper">
                                ...
                                <select class="form-select @error('theme') is-invalid @enderror" id="theme" name="theme" required>
                                    @foreach($themes as $themeKey => $themeLabel)
                                        <option value="{{ $themeKey }}" {{ old('theme', 'clean') === $themeKey ? 'selected' : '' }}>{{ $themeLabel }}</option>
                                    @endforeach
                                </select>
                                @error('theme')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group-wrapper" id="customStyleSection" style="display: none;">
                                ...
                                <textarea class="form-control @error('custom_style') is-invalid @enderror" id="custom_style" name="custom_style" rows="5" placeholder="Add custom CSS for the Custom theme.">{{ old('custom_style') }}</textarea>
                                @error('custom_style')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                ...
                <div class="card-section">
                    ...
                    <div class="form-group-wrapper">
                        ...
                        <input type="text" class="form-control @error('subject') is-invalid @enderror" id="subject" name="subject" value="{{ old('subject') }}" placeholder="Enter the email subject" required>
                        @error('subject')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            <div class="card-section" style="position: sticky; top: 20px;">
                ...
                <div style="background: #f8f9fa; border-radius: 10px; padding: 1.5rem; border: 1px solid #ddd;">
                    <div id="templatePreviewCard" style="background: white; border-radius: 8px; padding: 1.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); border: 1px solid #e0e0e0;">
                        <div id="previewType" style="font-weight: 600; color: #667eea; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 0.75rem;">General</div>
                        <div id="previewSubject" style="font-size: 1.25rem; font-weight: 700; color: #333; margin-bottom: 1rem; word-break: break-word;">Your Subject Here</div>
                        <div id="previewBody" style="color: #666; line-height: 1.6; font-size: 0.95rem; word-break: break-word;">Your message content will appear here...</div>
                    </div>
    ...
    <script>
        const themeStyles = {
            clean: {
                ...
                subjectColor: '#111827',
                bodyColor: '#374151',
                cardShadow: '0 8px 30px rgba(15, 23, 42, 0.06)'
            },
            modern: {
                background: '#f8fafc',
            ...
            warm: {
                ...
                subjectColor: '#92400e',
                bodyColor: '#7c2d12',
                cardShadow: '0 8px 28px rgba(124, 45, 18, 0.08)'
            },
            elegant: {
                background: '#f5f3ff',
                ...
                subjectColor: '#3730a3',
                bodyColor: '#4c51bf',
                cardShadow: '0 8px 28px rgba(55, 48, 163, 0.08)'
            },
            corporate: {
                background: '#f3f4f6',
            ...
            minimal: {
                ...
                subjectColor: '#111827',
                bodyColor: '#374151',
                cardShadow: '0 6px 20px rgba(15, 23, 42, 0.05)'
            },
            bold: {
                background: '#0f172a',
                ...
                subjectColor: '#f8fafc',
                bodyColor: '#e2e8f0',
                cardShadow: '0 12px 36px rgba(15, 23, 42, 0.35)'
            },
            soft: {
                background: '#fdf2f8',
                ...
                subjectColor: '#831843',
                bodyColor: '#6d28d9',
                cardShadow: '0 8px 28px rgba(139, 92, 246, 0.08)'
            },
            premium: {
                background: '#eef2ff',
                border: '1px solid #c7d2fe',
                ...
                subjectColor: '#312e81',
                bodyColor: '#4338ca',
                cardShadow: '0 8px 28px rgba(79, 70, 229, 0.1)'
            },
            festive: {
                background: '#fffbeb',
                ...
                subjectColor: '#92400e',
                bodyColor: '#78350f',
                cardShadow: '0 8px 28px rgba(202, 138, 4, 0.14)'
            },
            sunrise: {
                background: '#fff7ed',
                ...
                subjectColor: '#9a3412',
                bodyColor: '#7c2d12',
                cardShadow: '0 8px 28px rgba(220, 38, 38, 0.08)'
            },
            twilight: {
                background: '#eef2ff',
                ...
                subjectColor: '#312e81',
                bodyColor: '#4f46e5',
                cardShadow: '0 8px 28px rgba(79, 70, 229, 0.12)'
            },
            calm: {
                background: '#ecfdf5',
                ...
                subjectColor: '#14532d',
                bodyColor: '#166534',
                cardShadow: '0 8px 28px rgba(16, 185, 129, 0.08)'
            },
            vibrant: {
                background: '#fef9c3',
                border: '1px solid #f59e0b',
                ...
                subjectColor: '#92400e',
                bodyColor: '#7c2d12',
                cardShadow: '0 8px 28px rgba(217, 119, 6, 0.12)'
            },
            pastel: {
                background: '#f5f3ff',
            ...
            classic: {
                ...
                subjectColor: '#713f12',
                bodyColor: '#51362f',
                cardShadow: '0 8px 28px rgba(113, 63, 18, 0.1)'
            },
            tech: {
                background: '#0f172a',
                ...
                subjectColor: '#e2e8f0',
                bodyColor: '#cbd5e1',
                cardShadow: '0 12px 36px rgba(15, 23, 42, 0.4)'
            },
            luxury: {
                background: '#111827',
                border: '1px solid #f59e0b',
                ...
                subjectColor: '#f8fafc',
                bodyColor: '#e5e7eb',
                cardShadow: '0 12px 36px rgba(0, 0, 0, 0.48)'
            },
            natural: {
                background: '#ecfdf5',
            ...
            sleek: {
                ...
                subjectColor: '#f8fafc',
                bodyColor: '#cbd5e1',
                cardShadow: '0 12px 36px rgba(15, 23, 42, 0.5)'
            },
            custom: {
                background: '#ffffff',
                border: '1px solid #e0e0e0',

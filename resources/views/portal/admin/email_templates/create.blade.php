            ...
            <form action="{{ route('portal.admin.messages.email_templates.store') }}" method="POST" id="templateForm">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input list="categoryList" type="text" id="category" name="category" class="form-control custom-select @error('category') is-invalid @enderror" value="{{ old('category') }}" placeholder="e.g. Onboarding invitation, Account activation, Invoice reminder">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="text_body" name="text_body" class="form-control @error('text_body') is-invalid @enderror" rows="5" readonly>{{ old('text_body') }}</textarea>

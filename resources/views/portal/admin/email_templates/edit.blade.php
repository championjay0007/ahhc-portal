                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input list="functionKeyList" type="text" id="function_key" name="function_key" class="form-control custom-select @error('function_key') is-invalid @enderror" value="{{ old('function_key', $emailTemplate->slug) }}" placeholder="e.g. participant-onboarding-invitation">
